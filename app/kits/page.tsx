  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      <header className="mb-14">
        <span className="inline-flex items-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold uppercase tracking-wider px-3 py-1 rounded-full mb-5">
          Internal · not linked anywhere
        </span>
        <h1 className="text-4xl sm:text-5xl text-slate-900 dark:text-white leading-[1.05] tracking-tight mb-4">
          <span className="block font-light text-slate-500 dark:text-slate-400">ghlsaastheme</span>
        ...
        <div className="grid grid-cols-5 sm:grid-cols-10 gap-2 mb-8">
          {BRAND_SCALE.map((s) => (
            <div key={s.step}>
              ...
              />
              <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium mt-1.5 text-center">
                {s.step}
              </p>
            </div>
          ))}
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-4xl sm:text-5xl leading-[1.05] tracking-tight font-display">
              <span className="block font-light text-slate-500 dark:text-slate-400">
                One membership.
              </span>
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-xl mt-3">
      ...
      >
        <div className="flex flex-wrap items-center gap-5">
          ...
          <a
            href="#"
            className="inline-flex items-center justify-center gap-2 bg-white dark:bg-slate-900 hover:bg-slate-50 text-slate-900 dark:text-white font-semibold px-6 py-3 rounded-full border border-slate-200 dark:border-slate-700 transition-colors"
          >
            Secondary
          </a>

          <a href="#" className="text-orange-600 dark:text-orange-400 font-semibold hover:underline">
            Text link
          </a>

          <a
            href="#"
            className="text-sm text-slate-500 dark:text-slate-400 hover:text-orange-600 font-medium transition-colors"
          >
            Quiet link →
          </a>
        </div>
      ...
      >
        <div className="flex flex-wrap items-center gap-4">
          <span className="inline-flex items-center gap-2 bg-orange-50 dark:bg-orange-500/15 text-orange-600 dark:text-orange-400 text-sm font-semibold px-4 py-1.5 rounded-full border border-orange-100 dark:border-orange-500/30">
          ...
          <span className="inline-flex items-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold uppercase tracking-wider px-3 py-1 rounded-full">
            Neutral label
          </span>
        </div>
      </KitSection>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
                ...
                <h3 className="font-bold text-slate-900 dark:text-white mb-2 relative text-base">
                  Step title
                </h3>
            ...
            <div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 text-center shadow-sm">
                ...
                <p className="font-display font-bold text-3xl text-slate-900 dark:text-white tracking-tight">
                  {price(OFFER.price)}
      ...
      >
        <div className="grid sm:grid-cols-2 gap-6">
          <div>
            ...
            <div className="gw-hero-dot-bg h-40 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex items-center justify-center">
          ...
          <div>
            ...
            <div className="gw-animate-fade-up h-40 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 flex items-center justify-center">
